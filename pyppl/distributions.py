...
distributions = {
    ...
    Distribution('HalfCauchy',  DistributionType.CONTINUOUS, ['mu', 'gamma']),
    Distribution('LogGamma',    DistributionType.CONTINUOUS, ['alpha', 'beta']),
    Distribution('LogNormal',   DistributionType.CONTINUOUS, ['mu', 'sigma']),
    Distribution('Multinomial', DistributionType.DISCRETE,   ['total_count', 'probs', 'n']),
    Distribution('MultivariateNormal',
                                DistributionType.CONTINUOUS, ['mu', 'covariance_matrix'], vector_sample=True),
